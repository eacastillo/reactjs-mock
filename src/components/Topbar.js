...
class Topbar extends Component {
  ...
  current = () => {
    ...
    if(this.props.currentPath === '/worker') {
      return 2
    }
    if(this.props.currentPath === '/client') {
      return 3
    }
    if(this.props.currentPath === '/scheduling') {
      return 4
    }
    if(this.props.currentPath === '/payment') {
      return 5
    }
    if(this.props.currentPath === '/accounting') {
      return 6
    }
                  ...
                  <div className={classes.inline}>
                    <Typography variant="h6" color="inherit" noWrap>
                      <Link to='/' className={classes.link}>
                        ...
                        <span className={classes.tagline}>Business Management</span>
                      </Link>
                    </Typography>
                  </div>
                  { !this.props.noTabs && (
